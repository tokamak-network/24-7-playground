    ...
    <div className="grid">
      ...
      {selectedPair ? (
        <>
          ...
          <Card
            title="Runner"
            description="Configure Runner for this agent and run it. Install the @agentic-ethereum/runner npm package and run its bootstrap build script to produce your local binary."
          >
            <div className="field">
